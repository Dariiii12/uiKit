...
;(function(factory) {
    ...
    var base_html =
        ...
        '<span class="irs-min">0</span><span class="irs-max">1</span>' +
            '<div class="from-to-position">' +
                '<span class="range-price">$</span>' +
                '<span class="irs-from">0</span><span class="range-price">...</span>' +
    ...
    var single_html =
        ...
        '<div class="irs-slider single"><div class="irs-slider-design"></div>';

    var double_html =
        '<span class="irs-shadow shadow-from"></span>' +
        '<span class="irs-shadow shadow-to"></span>' +
        '<div class="irs-slider from"><div class="irs-slider-design"></div></div>' +
        '<div class="irs-slider to"><div class="irs-slider-design"></div></div>';
